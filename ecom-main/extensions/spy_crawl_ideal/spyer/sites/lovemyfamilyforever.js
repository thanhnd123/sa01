let Lovemyfamilyforever = class extends Initial {
    constructor() {
        super();
    ...
    getProduct() {
        let container = document.querySelector('#product_page');
        let title = container.querySelector('h1.product__name-product').innerText.trim();
        let banner;
        let images = [];
        document.querySelectorAll('ul.media-gallery-carousel__thumbs img').forEach(function (el, k) {
            let imageUrl = el.getAttribute('data-zoom');
